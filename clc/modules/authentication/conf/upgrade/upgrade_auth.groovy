...
class UpgradeAuth extends AbstractUpgradeScript {
  ...
  public void upgrade( File oldEucaHome, File newEucaHome ) {
    ...
    StandalonePersistence.getConnection("hippo").rows('SELECT * FROM AUTH_CLUSTERS').each{
      //println "ROW: ${it}";
    ...
    StandalonePersistence.getConnection("hippo").rows('SELECT * FROM AUTH_USERS').each{
      //println "ROW: ${it}";
      try {
    ...
    StandalonePersistence.getConnection("hippo").rows('SELECT * FROM AUTH_USER_HAS_X509').each{
      //println "ROW: ${it}";
    ...
    StandalonePersistence.getConnection("hippo").rows('SELECT * FROM AUTH_X509').each{
      //println "ROW: ${it}";
    ...
    StandalonePersistence.getConnection("hippo").rows('SELECT * FROM USERS').each{
      //println "ROW: ${it}";
      try {
