...
public class ImageAuthorization {
  @Id
  @GeneratedValue (strategy=GenerationType.SEQUENCE,generator="ImageAuthorization_seq")
  @SequenceGenerator(name="ImageAuthorization_seq",sequenceName="ImageAuthorization_seq")
