...
public class StateUpdateHandler implements EventListener {
  ...
  private static final ConcurrentMap<String,StateUpdateHandler> clusterMap = new ConcurrentHashMap<String,StateUpdateHandler>();
  private final ConcurrentMap<Class,AtomicBoolean> inflightMap = new ConcurrentHashMap<Class, AtomicBoolean>();
  private final ConcurrentMap<Class,QueuedEventCallback> callbackMap = new ConcurrentHashMap<Class,QueuedEventCallback>();
